...
const ContinuousSpellCards = () => {
  ...
  const handleFilterChange = (e) => {
    ...
    const filteredCardsList = continuousSpellCardData.filter((card) => {
  ...
  return (
    <div className="rendered-mapped-cards-container">
      <input
        ...
        type="text"
        placeholder="Search For Continuous Spell Cards"
        onFocus={(e) => (e.target.placeholder = "")}
        onBlur={(e) =>
          (e.target.placeholder = "Search For Continuous Spell Cards")
        }
