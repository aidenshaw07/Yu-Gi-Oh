...
const QuickPlaySpellCards = () => {
  ...
  const handleFilterChange = (e) => {
    ...
    const filteredCardsList = quickPlaySpellCardData.filter((card) => {
  ...
  return (
    <div className="rendered-mapped-cards-container">
      <input
        ...
        type="text"
        placeholder="Search For Quick Play Spell Cards"
        onFocus={(e) => (e.target.placeholder = "")}
        onBlur={(e) =>
          (e.target.placeholder = "Search For Quick Play Spell Cards")
        }
