...
const EquipSpellCards = () => {
  ...
  const [matchedCards, setMatchedCards] = useState(renderEquipSpellCardData);
  ...
  const handleFilterChange = (e) => {
    ...
    const filteredCardsList = equipSpellCardData.filter((card) => {
  ...
  return (
    <div className="rendered-mapped-cards-container">
      <input
        ...
        type="text"
        placeholder="Search For Equip Spell Cards"
        onFocus={(e) => (e.target.placeholder = "")}
        onBlur={(e) =>
          (e.target.placeholder = "Search For Equip Spell Cards")
        }
