...
const LinkMonsterCards = () => {
  ...
  const [matchedCards, setMatchedCards] = useState(renderLinkMonsterCardData);
  ...
  const handleFilterChange = (e) => {
    ...
    const filteredCardsList = linkMonsterCardData.filter((card) => {
  ...
  return (
    <div className="rendered-mapped-cards-container">
      <input
        ...
        type="text"
        placeholder="Search For Link Monster Cards"
        onFocus={(e) => (e.target.placeholder = "")}
        onBlur={(e) =>
          (e.target.placeholder = "Search For Link Monster Cards")
        }
