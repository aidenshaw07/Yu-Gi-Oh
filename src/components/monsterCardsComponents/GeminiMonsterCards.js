...
const GeminiMonsterCards = () => {
  ...
  const [matchedCards, setMatchedCards] = useState(renderGeminiMonsterCardData);
  ...
  const handleFilterChange = (e) => {
    ...
    const filteredCardsList = geminiMonsterCardData.filter((card) => {
  ...
  return (
    <div className="rendered-mapped-cards-container">
      <input
        ...
        type="text"
        placeholder="Search For Gemini Monster Cards"
        onFocus={(e) => (e.target.placeholder = "")}
        onBlur={(e) =>
          (e.target.placeholder = "Search For Gemini Monster Cards")
        }
