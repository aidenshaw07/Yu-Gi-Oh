...
const TunerMonsterCards = () => {
  ...
  const [matchedCards, setMatchedCards] = useState(renderTunerMonsterCardData);
  ...
  const handleFilterChange = (e) => {
    ...
    const filteredCardsList = tunerMonsterCardData.filter((card) => {
  ...
  return (
    <div className="rendered-mapped-cards-container">
      <input
        ...
        type="text"
        placeholder="Search For Tuner Monster Cards"
        onFocus={(e) => (e.target.placeholder = "")}
        onBlur={(e) =>
          (e.target.placeholder = "Search For Tuner Monster Cards")
        }
