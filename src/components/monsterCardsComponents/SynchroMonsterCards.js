...
const SynchroMonsterCards = () => {
  ...
  const handleFilterChange = (e) => {
    ...
    const filteredCardsList = synchroMonsterCardData.filter((card) => {
  ...
  return (
    <div className="rendered-mapped-cards-container">
      <input
        ...
        type="text"
        placeholder="Search For Synchro Monster Cards"
        onFocus={(e) => (e.target.placeholder = "")}
        onBlur={(e) =>
          (e.target.placeholder = "Search For Synchro Monster Cards")
        }
